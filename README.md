...
* 별도로 '네이버'사의 글꼴을 사용하였습니다. <https://hangeul.naver.com/font>
  + 사용된 폰트: 나눔 스퀘어   
* * *
1. 어플리케이션에 사용된 ic_map, ic_move_to_inbox, ic_notification_black, ic_settings, ic_settings_outline, ic_start, ic_start_border, ic_update, ic_warning xml 파일들은 Google Material Design 아이콘을 사용하였습니다. <https://material.io/resources/icons/?style=baseline> Available under [Apache license version 2.0](https://www.apache.org/licenses/LICENSE-2.0.html, "Apache license link")   
